...
# Start-ScheduledTask -TaskName "WSLMonitoringLab_v2"

# Посмотреть статус задачи 
# Get-ScheduledTask -TaskName "WSLMonitoringLab_v2" | Get-ScheduledTaskInfo


# удалить задачу
# Unregister-ScheduledTask -TaskName "WSLMonitoringLab_v2" -Confirm:$false